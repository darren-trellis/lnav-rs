...
pub fn defaults() -> BTreeMap<String, String> {
    BTreeMap::from([
        ...
        ("A-S-left".into(), "config set sidebar.width +1".into()),
        ("A-S-h".into(), "config set sidebar.width +1".into()),
        ("A-S-right".into(), "config set sidebar.width -1".into()),
        ("A-S-l".into(), "config set sidebar.width -1".into()),
        ("A-S-up".into(), "config set details.max_height +1".into()),
        ("A-S-k".into(), "config set details.max_height +1".into()),
        ("A-S-down".into(), "config set details.max_height -1".into()),
        ("A-S-j".into(), "config set details.max_height -1".into()),
